...
class AdminController extends Controller
{
    public function index()
    {
        ...
        // Ottieni statistiche mensili degli ordini per l'anno corrente
    ...
    {
        $order = Order::with('orderItems.product.category', 'orderItems.product.brand')->find($order_id);
        ...
        $transaction = $order->transaction; // Usa la relazione definita in Order
