    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.brand.store') }}" method="POST"
                ...
                @error('name') <span class="alert alert-danger">{{ $message }}</span>
                <fieldset class="name">
                ...
                @error('slug') <span class="alert alert-danger">{{ $message }}</span>
                <fieldset>
                ...
                @error('image') <span class="alert alert-danger">{{ $message }}</span>
